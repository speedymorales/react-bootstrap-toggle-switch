...
var Bootstrap4Toggle = function (_a) {
    ...
    var changeState = function (checked) {
        setState(__assign(__assign({}, state), { checked: checked }));
        if (onChange)
            onChange(checked);
    };
    var toggle = function () {
    ...
    return (React__namespace.createElement("div", { className: "btn toggle " + checkedStyle + sizeClass + extraClasses + disabledClass, "data-toggle": "toggle", tabIndex: !state.disabled ? state.tabIndex : undefined, style: toggleStyle, onClick: toggle, onKeyDown: onKeyDown },
